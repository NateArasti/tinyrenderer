...
constexpr std::string_view APP_NAME = "tiny renderer";
...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, APP_NAME.data(), nullptr, nullptr);
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.proj[1][1] *= -1; // Y axis adjustment for glm
    ...
    {
        auto app = reinterpret_cast<TinyRenderer*>(glfwGetWindowUserPointer(window));
...
int main()
{
    std::cout << "Starting session of tiny-renderer" << std::endl;
    ...
    std::cout << "Ending session of tiny-renderer" << std::endl;
    return EXIT_SUCCESS;
}
